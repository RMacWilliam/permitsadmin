...
export interface IApiUpdateEmailRequest {
    oldEmail?: string;
    newEmail?: string;
    vin?: string;
    permitType?: number;
...
export interface IApiUpdateEmailResultData {
    isValid?: boolean;
    message?: string;
}

export interface IApiUpdateEmailResult {
    isSuccessful?: boolean;
    errorMessage?: string;
    data?: IApiUpdateEmailResultData;
}

export function apiUpdateEmail(body?: any, params?: any): Observable<IApiUpdateEmailResult> {
    return httpPost<IApiUpdateEmailResult>(WebApi.UpdateEmail, params, body, false);
}
...
export interface IApiGetPermitTypesRequest {

}

export interface IApiGetPermitTypesResult extends IKeyValue {

}

export function apiGetPermitTypes(params?: any): Observable<IApiGetPermitTypesResult[]> {
    return httpGet<IApiGetPermitTypesResult[]>(WebApi.GetPermitTypes, params, false);
}
