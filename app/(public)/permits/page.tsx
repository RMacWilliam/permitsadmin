...
import { AppContext, IKeyValue, ISnowmobile } from '@/app/AppContext';
import { useRouter } from 'next/navigation';
import { formatShortDate, getKeyValueFromSelect } from '@/app/custom/utilities';
import Button from 'react-bootstrap/Button';
import Modal from 'react-bootstrap/Modal';
import { v4 as uuidv4 } from 'uuid';
import { clubsData, permitOptionsData, snowmobileMakesData } from '@/app/custom/data';
...
export default function PermitsPage() {
    ...
    return (
        <>
            ...
            {snowmobiles.length > 0 && snowmobiles.map(x => (
